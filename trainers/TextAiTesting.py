...
colums_text = pd.Series(colums_text)

with open('text_cleaned_variable.pkl', 'rb') as file:
    data = pickle.load(file)

x_train, x_val, y_train, y_val = train_test_split(data['colums_text'], data['train_labels'], test_size=0.3, random_state=24)

with open('tokenizer.pkl', 'rb') as f:
        loaded_tokenizer = pickle.load(f)

## ------------------------------------------ cnn -------------------------------------
model2 = tf.keras.models.load_model('text_classification_cnn.h5')
...
model3 = tf.keras.models.load_model('text_classification_biLSTM_attention.h5', custom_objects = {'attention': attention})
